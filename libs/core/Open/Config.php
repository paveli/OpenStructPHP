...
class Open_Config extends Open_Singleton
{
	...
	/**
	 * Проверить существование параметра по имени и секции в конфиге
	 *
	 * @param string $section Имя секции. Если секция не указана, берётся секция по умолчанию
	 * @param string $name Имя параметра. Если не указано, значит имя секции - это имя параметра
	 * @return bool
	 */
	public function exists($section, $name=NULL)
	{
		...
		/**
		 * Проверяем существование и возвращаем результат
		 */
