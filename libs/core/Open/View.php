...
class Open_View extends Open_Singleton
{
	...
	/**
	 * Типы URL статических данных
	 */
	const URL_TYPE_JS = 0x01;
	const URL_TYPE_CSS = 0x02;
	...
	{
		return $this->getStaticUrl($url, self::URL_TYPE_JS);
	}
	 ...
	 * @return
	 */
	public function getCssUrl($url)
	{
		return $this->getStaticUrl($url, self::URL_TYPE_CSS);
	}
