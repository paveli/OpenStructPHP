...
/**
 * URL-путь к библиотеке YUI
 */
//define('YUI_PATH', 'http://yui.yahooapis.com/2.5.2/build/');
define('YUI_PATH', 'http://s.open.by/yui/2.5.2/build/');
 ...
 */
$data['auto_xss_clean'] = FALSE;

/**
 * Название приложения
 */
$data['application_name'] = 'Hello World!';
 ...
 * Если путь не абсолютный, то БЕЗ расширения
 */
$data['css'] = array(
	YUI_PATH .'reset-fonts-grids/reset-fonts-grids'. CSSEXT,
	YUI_PATH .'base/base-min'. CSSEXT,
	'common',
);
 ...
 */
$data['js'] = array(
	YUI_PATH .'utilities/utilities'. JSEXT,
);
